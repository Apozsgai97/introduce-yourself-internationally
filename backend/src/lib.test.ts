...
import { addUsername, rightFormatName } from "./lib";
...
test("change NAME to username.", () => {
  ...
  deepEqual(
    result,
    "Hi! My name is Adrienn. Nice to meet you! What's your name?"
  );
});
...
/* 
 Used the tests for the makeIntroduction function with the mock data. 
...
Used the test for sliceResult function but found better solution. 
